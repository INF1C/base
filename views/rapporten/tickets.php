		...
		<form class="form-inline" method="POST" action="" role="form">
			<div class="form-group">
	    		...
	    		<div class="input-append date form_datetime" id="start" data-date-format="yyyy-mm-dd hh:mm:ss">
	    			<input class="span2" name="start" type="text"  value="<?= $start ?>" readonly placeholder="YYYY-MM-DD HH:MM:SS">
			...
			<div class="form-group">
	    		...
	    		<div class="input-append date form_datetime" id="stop" data-date-format="yyyy-mm-dd hh:mm:ss">
	    			<input class="span2" name="stop" type="text" value="<?= $stop ?>" readonly placeholder="YYYY-MM-DD HH:MM:SS">
	    			<span class="add-on"><i class="icon-th"></i></span>
	    		</div>
    		</div>
    		<br/><br/>
