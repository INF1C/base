            ...
            <aside>
                <div id="sidebar"  class="nav-collapse " tabindex="5000" style="overflow: hidden; outline: none; margin-left: 0px;">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        $db = NULL;
                        ?>
                        <p class="centered"><img src="<?= $afbeelding ?>" alt="avatar" style="max-width: 50%" class="img-responsive img-circle" onError="this.onerror=null;this.src='https://cdn2.iconfinder.com/data/icons/danger-problems/512/anonymous-512.png';"/></p>
